    ...
    <div class="container-table100">
        <div class="wrap-table100">
            ...
            <div class="table100">
                <table>      <!-- 테 이 블 -->
                    <thead>
                    <tr class="table100-head">     <!-- 안바뀌는 친구들 -->
                    ...
                    <tbody>
                    <?php
                        # TODO : 아래 표시되는 내용을, MySQL 테이블에 있는 레코드로 대체하기! 바로 아래 태그 참조
                    ...
                    while ($row = mysql_fetch_array($result))
                    {
                        ...
                        echo "<td class=\"column6\">$row[total]</td>";
                        echo "</tr>";
                    }
                    ?>

<!--
                    <tr onclick="location.href = ('board_form.php?num=0')"> , tr 이 행인데 onclick 했을 떄의 이벤트 , 어디로 이동하는지, num은 primary 키가 되겠지,
