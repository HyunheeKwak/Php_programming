...
if(isset($_GET[num])) { # num 이 get parameter에 있는 지 없는지
...
<div class="limiter">
	<div class="container-table100">
		<div class="wrap-table100">
            ...
            <?php
                if(isset($_GET[num])) {
                    echo "<form method=\"POST\" action=\"function/update.php?num=$_GET[num]\">"; #insert 랑 update 폼 구분, 같은 폼 쓰니까,,
                } else {
            ...
            ?>
				<div class="table100">
					<table>
						...
						<tr>
                            <?php
                            if(isset($_GET[num])) { //update 의 경우!, 수정 하기 했을때 기본값 넣어주기(사용자 편의를 위해서)
                                ?>
                ...
                <?php
                    if(isset($_GET[num])) { # update 나 delete
                ?>
